...
// discuss: https://leetcode.com/problems/find-the-number-of-ways-to-place-people-ii/discuss/?currentPage=1&orderBy=most_votes&query=
...
impl Solution {
    pub fn number_of_pairs(mut points: Vec<Vec<i32>>) -> i32 {
        ...
        for (i, point1) in points.iter().enumerate() {
            ...
            let mut max_height2 = i32::MIN;

            for point2 in points.iter().skip(i + 1) {
                let height2 = point2[1];

                if height2 <= height1 && height2 > max_height2 {
                    max_height2 = height2;
                    result += 1;
                }
            }
