...
///
/// * `n == balance.length`
/// * `1 <= n, account, account1, account2 <= 10<sup>5</sup>`
/// * `0 <= balance[i], money <= 10<sup>12</sup>`
/// * At most `10<sup>4</sup>` calls will be made to **each** function `transfer`, `deposit`, `withdraw`.
///
pub struct Solution {}
...
impl Bank {
    ...
    fn transfer(&mut self, account1: i32, account2: i32, money: i64) -> bool {
        ...
        if account1 < self.n && account2 < self.n && self.balance[account1] >= money {
    ...
    fn withdraw(&mut self, account: i32, money: i64) -> bool {
        ...
        if account < self.n && self.balance[account] >= money {
            self.balance[account] -= money;
            true
        } else {
            false
