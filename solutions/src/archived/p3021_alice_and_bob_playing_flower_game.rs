...
// discuss: https://leetcode.com/problems/alice-and-bob-playing-flower-game/discuss/?currentPage=1&orderBy=most_votes&query=
...
impl Solution {
    pub fn flower_game(n: i32, m: i32) -> i64 {
        (n as i64 / 2) * (m as i64 - m as i64 / 2) + (m as i64 / 2) * (n as i64 - n as i64 / 2)
    }
}
