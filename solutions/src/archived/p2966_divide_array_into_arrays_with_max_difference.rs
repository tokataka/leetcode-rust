...
// discuss: https://leetcode.com/problems/divide-array-into-arrays-with-max-difference/discuss/?currentPage=1&orderBy=most_votes&query=
...
mod tests {
    ...
    fn test_2966() {
        ...
        let k = 2;
        let expected = nd_vec![[1, 1, 3], [3, 4, 5], [7, 8, 9]];
