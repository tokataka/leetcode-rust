...
// discuss: https://leetcode.com/problems/vowels-game-in-a-string/discuss/?currentPage=1&orderBy=most_votes&query=
...
mod tests {
    ...
    fn test_3227() {
        ...
        let expected = true;
        assert_eq!(Solution::does_alice_win(s), expected);
        let s = "bbcd".to_owned();
        let expected = false;
        assert_eq!(Solution::does_alice_win(s), expected);
    }
